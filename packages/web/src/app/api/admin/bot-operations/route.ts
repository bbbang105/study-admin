...
export const GET = withAdminAuth(async () => {
  const operations = [
    ...
    },
    {
      ...
      category: 'attendance',
      schedule: '자동: 매일 08:00 (D-2일 때)',
      running: false,
    },
    {
      id: 'deadline-reminder-d1',
      name: '마감 리마인더 (D-1)',
      description: '미제출 활성 멤버에게 D-1 리마인더 DM을 발송합니다',
      category: 'attendance',
      schedule: '자동: 매일 08:00 (D-1일 때)',
      running: false,
    },
    {
      id: 'deadline-reminder-d0',
      name: '마감 리마인더 (D-day)',
      description: '미제출 활성 멤버에게 D-day 리마인더 DM을 발송합니다',
      category: 'attendance',
      schedule: '자동: 매일 08:00 (D-day일 때)',
      running: false,
    },
    {
      id: 'curation-crawl',
      name: '큐레이션 크롤링',
      description: '외부 소스에서 기술 컨텐츠를 크롤링합니다',
      category: 'curation',
      schedule: '매일 23:00',
      running: false,
      disabled: true,
    ...
    },
    {
      id: 'curation-share',
      name: '큐레이션 공유',
      description: '크롤링한 컨텐츠를 디스코드 채널에 공유합니다',
      category: 'curation',
      schedule: '매일 10:00',
      running: false,
      disabled: true,
